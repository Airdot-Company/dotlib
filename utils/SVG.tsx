...
export function ExternalIcon(props?: SVGProps) {
    return (
        <svg style={props?.style} className={`icon outbound ${props?.className == null ? "" : props.className}`} xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15">
